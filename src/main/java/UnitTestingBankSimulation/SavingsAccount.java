...
public class SavingsAccount extends Account {
	 ...
	 */
	public SavingsAccount(Customer cust, double initialBalance, String description) {
	 ...
	 */
	public SavingsAccount(Customer cust, double initialBalance, String description, double interestRate) {
		super(cust, initialBalance, description);
		// Stub
	}
